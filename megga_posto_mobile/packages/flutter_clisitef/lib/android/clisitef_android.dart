...
class CliSiTefAndroid implements CliSiTefSDK {
  ...
  static const MethodChannel _methodChannel = MethodChannel('br.com.claudneysessa.clisitef');

  static const EventChannel _eventChannel = EventChannel('br.com.claudneysessa.clisitef/events');

  static const EventChannel _dataChannel = EventChannel('br.com.claudneysessa.clisitef/events/data');
  ...
  void setEventHandler(TransactionEvent2Void? transactionEventHandler, PinPadEvent2Void? pinPadEventHandler) {
    _eventChannel.receiveBroadcastStream().listen(
        (event) => handleEvent(event, transactionEventHandler, pinPadEventHandler),
  ...
  Future<int?> getTotalPendingTransactions(DateTime dataFiscal, String cupomFiscal) async {
    return await _methodChannel.invokeMethod<int?>('getQttPendingTransactions',
        {'dataFiscal': DateFormat('yyyyMMdd').format(dataFiscal), 'cupomFiscal': cupomFiscal});
  }
  ...
  handleError(PlatformException exception, TransactionEvent2Void? transactionEventHandler,
